...
// TicTacToe(Server).cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTicTacToeServerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTicTacToeServerApp

CTicTacToeServerApp::CTicTacToeServerApp()
{
...
// Единственный объект CTicTacToeServerApp

CTicTacToeServerApp theApp;


// Инициализация CTicTacToeServerApp

BOOL CTicTacToeServerApp::InitInstance()
{
